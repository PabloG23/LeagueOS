...
public class SecurityConfig {
    ...
    private final com.leagueos.shared.infrastructure.filter.TenantContextFilter tenantContextFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/api/public/**", "/public/**", "/api/tenants/settings/**", "/api/admin/system/seed", "/api/v1/bomberazo/**", "/error").permitAll()
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.List.of("http://localhost:5173", "https://league-os-weld.vercel.app"));
        configuration.setAllowedMethods(java.util.List.of("GET", "POST", "PUT", "DELETE", "OPTIONS", "PATCH"));
        configuration.setAllowedHeaders(java.util.List.of("*", "X-Tenant-ID"));
